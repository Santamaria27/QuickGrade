...
#FEEDBACK
# response = client.chat.completions.create(model = "gpt-3.5-turbo",
# messages = [{"role": "user","content":"Third law For every action this us an equal and opposite saction. Second law: Planets Move In elliphical orbits with Sun at оп Јосия. This is the answer given by a student for the question to state the newton's laws of motion. Which all laws has he correctly mentioned?How much marks would you give out of 3?"}],
# temperature=0.2,
# #   max_tokens=100,
# #   top_p=1,
# #   frequency_penalty=0,
